    ...
    <div className="physical-education-container">
      ...
      >
        <p>
          ...
          self-sufficient and valuably functional. This means each function has
          a value or adds value to your life.
        </p>
        <p>
        ...
        <p>
          Body, mind, and soul are three intrinsic units that make our being. In
          making choices in life, you will note the difficulties you might
        ...
        <p>
          ...
          used over time to protect people from disease. Physical activity is a
          preventive way of living healthy.
        </p>
        <p>
        ...
        <p>
          Lack of physical activity leads to ill health. The energy that you get
          from food is supposed to all be expended in activity. Excess energy
          can cause disease.
        </p>
        <p>
          Physical activity requires resilience, perseverance, and discipline
          which take time to acquire. If you&apos;re young start now and you&apos;ll not
          struggle later.
        </p>
        <p>
          For the old, it&apos;s not too late, you can still protect yourself from
          sickness by changing your habits, building a routine, to shape your
          character and transform your lifestyle. Start small, skip rope, walk
          around the neighborhood, take the stairs, start jogging, play games.
        </p>
